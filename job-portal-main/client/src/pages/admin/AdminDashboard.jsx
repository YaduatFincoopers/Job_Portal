...
// import UserManagementModal from "../../admin/Managepopup";
                            ...
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            className={`inline-flex items-center justify-center gap-2 text-sm font-medium h-9 rounded-md px-3 transition-colors text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:brightness-110 ${
                                            ...
                                            onClick={() => {
                                                if (sec.status !== "Coming Soon") {
                                                    if (sec.title === "Test Generator") {
                                                        navigate("/admin/TestGenerator");
                                                    } else if (sec.title === "User Management") {
                                                        setShowUserModal(true);
                                                    } else if (sec.title === "Job Applications") {
